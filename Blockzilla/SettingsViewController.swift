...
class SettingsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.textLabel?.text = UIConstants.strings.settingsSearchTitle
            cell.detailTextLabel?.text = searchEngineManager.activeEngine.name
            cell.accessoryType = .disclosureIndicator
            cell.accessibilityIdentifier = "SettingsViewController.searchCell"
        case 4:
            if indexPath.row == 1 {
                cell = UITableViewCell(style: .subtitle, reuseIdentifier: "learnMoreCell")
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        switch section {
        case 0: labelText = UIConstants.strings.settingsSearchSectionTitle
...
extension SettingsViewController: SearchSettingsViewControllerDelegate {
    func searchSettingsViewController(_ searchSettingsViewController: SearchSettingsViewController, didSelectEngine engine: SearchEngine) {
        tableView.cellForRow(at: IndexPath(row: 0, section: 1))?.detailTextLabel?.text = engine.name
    }
}
