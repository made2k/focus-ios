...
struct UIConstants {
    ...
    struct strings {
        ...
        static let settingsSearchSectionTitle = NSLocalizedString("Settings.searchSectionTitle", value: "SEARCH", comment: "Title for the search engine section in settings screen.")
